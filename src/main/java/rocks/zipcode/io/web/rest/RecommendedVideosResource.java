...
public class RecommendedVideosResource {
    ...
    @Timed
    public ResponseEntity<RecommendedVideos> getRecommendedVideos(@PathVariable Long id) {
    ...
    @Timed
    public ResponseEntity<Void> deleteRecommendedVideos(@PathVariable Long id) {
