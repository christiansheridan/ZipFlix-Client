...
describe('Comment e2e test', () => {
    ...
    it('should load Comments', async () => {
        ...
        expect(await commentComponentsPage.getTitle()).to.eq('sampleappApp.comment.home.title');
    });
    ...
    it('should load create Comment page', async () => {
        ...
        expect(await commentUpdatePage.getPageTitle()).to.eq('sampleappApp.comment.home.createOrEditLabel');
    ...
    it('should create and save Comments', async () => {
        ...
        await commentComponentsPage.clickOnCreateButton();
        await promise.all([commentUpdatePage.setCommentInput('comment'), commentUpdatePage.videoSelectLastOption()]);
    ...
    it('should delete last Comment', async () => {
        ...
        expect(await commentDeleteDialog.getDialogTitle()).to.eq('sampleappApp.comment.delete.question');
