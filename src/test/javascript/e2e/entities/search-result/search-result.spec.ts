...
describe('SearchResult e2e test', () => {
    ...
    it('should load SearchResults', async () => {
        ...
        expect(await searchResultComponentsPage.getTitle()).to.eq('sampleappApp.searchResult.home.title');
    });
    ...
    it('should load create SearchResult page', async () => {
        ...
        expect(await searchResultUpdatePage.getPageTitle()).to.eq('sampleappApp.searchResult.home.createOrEditLabel');
    ...
    it('should delete last SearchResult', async () => {
        ...
        expect(await searchResultDeleteDialog.getDialogTitle()).to.eq('sampleappApp.searchResult.delete.question');
