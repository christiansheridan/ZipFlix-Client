...
describe('Rating e2e test', () => {
    ...
    it('should load Ratings', async () => {
        ...
        expect(await ratingComponentsPage.getTitle()).to.eq('sampleappApp.rating.home.title');
    });
    ...
    it('should load create Rating page', async () => {
        ...
        expect(await ratingUpdatePage.getPageTitle()).to.eq('sampleappApp.rating.home.createOrEditLabel');
    ...
    it('should create and save Ratings', async () => {
        ...
        await ratingComponentsPage.clickOnCreateButton();
        await promise.all([ratingUpdatePage.setRatingInput('5'), ratingUpdatePage.videoSelectLastOption()]);
    ...
    it('should delete last Rating', async () => {
        ...
        expect(await ratingDeleteDialog.getDialogTitle()).to.eq('sampleappApp.rating.delete.question');
